#ifndef HIOP_EXAMPLE_EX2_SPARSE_RAJA
#define HIOP_EXAMPLE_EX2_SPARSE_RAJA
...
//basecase sparse NLP
#include "nlpPriDec_EX2_user_basecase.hpp"

//recourse Sparse NLP
#include "nlpPriDec_EX2_user_recourse_sparse_raja.hpp"
 ...
 *
 * The basecase NLP problem is given by SparseEX1 and the recourse problems are nonconvex
...
private:
  ...
  // basecase problem
  PriDecBasecaseProbleEX2* basecase_;
};
