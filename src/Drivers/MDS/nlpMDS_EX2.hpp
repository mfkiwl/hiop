 ...
 */
class MDSEX2 : public hiop::hiopInterfaceMDS
{
public:
  MDSEX2(int ns)
    : MDSEX2(ns, ns, true, true, true)
  {
  }
  
  MDSEX2(int ns, int nd, bool convex_obj, bool rankdefic_Jac_eq, bool rankdefic_Jac_ineq)
    : ns_(ns),
